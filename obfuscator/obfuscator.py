...
class Obfuscator(commands.Cog):
    ...
    async def obfuscatorset_settings(self, ctx: commands.Context):
        ...
        if global_watermark:
            embed.add_field(name="Global Watermark:", value=str(global_watermark), inline=False)
